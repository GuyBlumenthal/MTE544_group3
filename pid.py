...
class PID_ctrl:
    ...
    def __update(self, stamped_error):
        ...
        # Keep history_length error points
        ...
        # Log errors in the form: error, error_dot, error_int and time stamp
        ...
        # Implement the P, PD, PI and PID controllers
        if self.type == P:
            return self.kp * latest_error
