...
class motion_executioner(Node):
    ...
    def laser_callback(self, laser_msg: LaserScan):
        ...
        self.laser_logger.log_values([
            f"[{' : '.join(ranges)}]",                          # list of ranges, : as a seperater
    ...
    def timer_callback(self):
        ...
        # Wait until we have all sensors initialized. Once they are store the init time
    ...
    def make_spiral_twist(self):
        ...
        msg.linear.x = min(float(self.get_seconds() - self.init_time) * linear_coeff, max_speed)
        msg.angular.z = 1.5
